...
from sklearn.metrics import accuracy_score, balanced_accuracy_score, f1_score, roc_auc_score, roc_curve, confusion_matrix, cohen_kappa_score
import numpy as np
import pandas as pd
...
def calculate_metrics_test(labels, predictions, probs, th1 = 0.7): #use probs
    ...
    print("--------------------")
    print(f"---with experimental threshold = {th1} :")
